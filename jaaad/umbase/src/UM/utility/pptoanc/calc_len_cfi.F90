...
! -------   ----     -------
!          19/12/96  Original code. Catherine Jones
...
! Local Scalars
      ...
      integer ierr       ! return code from ibm2cri
...
! Local dynamic arrays:
      ...
      real*4 levels_in(cols_nowrap*len1_rowdepc)
...
#if defined(CRAY)
        ierr=ibm2cri(3,rows*columns,levels_in,0,levels_array,1,64,32)
#else
