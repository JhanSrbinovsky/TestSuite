...
#if defined(NEC) && !defined(LINUX)
! SX6 (not TX7) requires "kind 8" logicals
...
! functions called
#if defined(CRAY)
      integer (kind=integer64) ::ibm2cri
#else
...
! Convert Integer part of header (Words 1-45)
        ier = ibm2cri (2,45,pp_buffer,0,pp_int,1,64,32)

! Convert Real part of header (Words 46-64)
        ier = ibm2cri (3,19,pp_buffer(23),32,pp_real,1,64,32)
#else
! Convert Integer part of header (Words 1-45)
