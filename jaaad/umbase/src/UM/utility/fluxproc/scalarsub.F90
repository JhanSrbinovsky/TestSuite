...
!     ScalarSub: subroutine to subtract an array
!     ---------- from a scalar.
...
!     Method:
!     -------  loop over all elements, subtracting unless either is
...
!     ------
     ...
     &      ,scalar                                                     &
                        ! IN scalar
     &      ,in_field(nx,ny)   ! IN array of input values (subtrahend)

!     Output
!     ------

      REAL                                                              &
     &       out_field(nx,ny)  ! OUT results of subtraction
...
! ------------------------------------------------------------------
      ...
      icode  = 0
      cmessage='ScalarSub: subtraction successful.'
