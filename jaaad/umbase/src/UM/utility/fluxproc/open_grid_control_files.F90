...
#endif
#if defined(FLXPLIN)
      subroutine open_grid_control_files ( icode )
...
!----------------------------------------------------------------------
! 0. Preliminaries
      CSub = 'open_grid_control_files'  ! subroutine name for errors
...
9999  continue
      return
      END SUBROUTINE open_grid_control_files
#endif
