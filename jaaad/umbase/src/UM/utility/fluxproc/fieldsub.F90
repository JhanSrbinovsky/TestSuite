...
!     FieldAdd: subroutine to subtract two arrays.
...
!     Method:
!     -------  loop over all elements, subtracting unless either
...
!     ------
     ...
     &      ,in_field2(nx,ny)  ! IN array of input values (subtrahend)
...
! ------------------------------------------------------------------
      ...
      icode = 0
      cmessage="FieldSub: subtraction successful."
