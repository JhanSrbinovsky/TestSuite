...
!   5.2   13/03/01   Add height_gen_method.  P.Selwood
...
Type grid_type
 ...
 ! Now the Local variables (in MPP sense)
  ...
  Real, Pointer :: rh_crit( : )
  Real, Pointer :: soil_depths( : )

  ! VarRes horizontal grid spacing
  Real, Pointer ::  Lambda_input_p( : )
  Real, Pointer ::  Lambda_input_u( : )
  Real, Pointer ::  Phi_input_p( : )
  Real, Pointer ::  Phi_input_v( : )
End Type grid_type
