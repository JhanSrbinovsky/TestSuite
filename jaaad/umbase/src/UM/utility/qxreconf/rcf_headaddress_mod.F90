...
!   5.2    5/03/00   Add Height Generation Method to IC
!                    and new Level Dependent Constants.  P.Selwood.
!   5.3    22/01/02   Add magic no. "DataSet Format Version" I.Edmond
!   5.5    06/01/03  River routing support. P.Selwood.

!   5.4   12/06/02   GRIBPrep. Added new parameter for 'pressure' LDC
!                                               Rod.Sharp
!   6.2   20/06/05   GRIBPrep. Added new parameter for 'index' LDC
!                               Paul Earnshaw (frpe)
!
! Code Description:
!   Language: FORTRAN 90
...
Integer, Save     :: Um_Sector_Size        ! sectors for Well-Formed IO
