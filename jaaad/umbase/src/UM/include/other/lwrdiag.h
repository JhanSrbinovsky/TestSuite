...
!                     (J. M. Edwards)
!
!  5.5      12/12/01  Absorptivity and ISCCP
!                     diagnostics included
!                     (A.B.Keen/K.D.Williams)
!  6.1      05/05/04  ISCCP cloud optical depth, top
!                     pressure and total cloud area
!                     diagnostics added.
!                     (A. Jones)
!  6.2      15/11/05  Added aerosol optical depth
!                     diagnostics.
!                     (N. Bellouin)
!  6.2      19/01/06  Diagnostics for radiances added. Required
!                     for version 3Z of the radiation code
!                                          (J.-C. Thelen)
!  6.4      16/01/07  Add new grid-box mean cloud diagnostics.
!                     (Adrian Lock)
!
!- ---------------------------------------------------------------------
!
