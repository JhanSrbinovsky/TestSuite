...
!                     (J. M. Edwards)
!  5.4      29/05/02  Column-integrated cloud droplet and warm-cloud-
!                     only satellite-view rE diagnostics added.
!                     (A. Jones)
!  5.5      12/12/01  Extinction diagnostics included
!                     (A.B.Keen/K.D.Williams)
!  6.2      19/01/06  Diagnstics for orography, radiances and
!                     UV-fluxes include. These are required for
!                     versions 3C and 3D of the radiation code.
!                                             (J.-C. Thelen)
!
!
!- ----------------------------------------------------------------------
