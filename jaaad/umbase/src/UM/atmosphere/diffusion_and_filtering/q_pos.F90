...
! ----     -------     -------
! 6.1      21/04/04    rewrite from scratch to correct myriad problems
!                                                         Andy Malcolm
! 6.2       21/11/05    Check to stop division by zero      A. Malcolm
! 6.2       05/01/06    Make messages more informative      A. Malcolm
! 6.2      14/06/06    fix error in logic         Andy Malcolm
! 6.4      14/11/06    fix error in logic for non-local   Andy Malcolm
!
! Code Description:
...
!                AT A TIME.
!---------------------------------------------------------------------
!  Set all polar points equal
!AJM this code should be redundant (inputs should be constant)
          TEMP1 = 0.0
          TEMP2 = 0.0
          DO I = 1, ROW_LENGTH
            TEMP1 = TEMP1 + q(I,K)
            TEMP2 = TEMP2 + q(P_FIELD-ROW_LENGTH+I,K)
          END DO
          DO I = 1, ROW_LENGTH
            q(I,K) = TEMP1/ROW_LENGTH
            q(P_FIELD-ROW_LENGTH+I,K) = TEMP2/ROW_LENGTH
          END DO
!AJM end of redundant code
