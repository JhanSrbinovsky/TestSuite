...
! DEPENDS ON: scmoutput
          Call SCMoutput(t_work,                                        &
               'dt_pc2init','Temperature increment PC2 init','K',       &
...
! DEPENDS ON: scmoutput
          Call SCMoutput(qcl_work,                                      &
               'dqcl_pc2init','QCL increment PC2 init','kg/kg',         &
               t_inst,d_wet,default_streams,'',RoutineName)

!         Stash 16,164
! DEPENDS ON: scmoutput
          Call SCMoutput(qcf_work,                                      &
               'dqcf_pc2init','QCF increment PC2 init','kg/kg',         &
               t_inst,d_wet,default_streams,'',RoutineName)
