...
! *****************************COPYRIGHT*******************************
!
       SUBROUTINE stph_rp(max_model_levels,                             &
...
!
! Code author:  Alberto Arribas
!               alberto.arribas@metoffice.gov.uk
!
...
IF (PrintStatus  >  PrStatus_Normal) THEN
    WRITE(6,*) ' STPH_RP '
    WRITE(6,*) ' STPH_RP OLD PARAM VALUES'
#if defined(A05_4A)
...
!----------------------------------------------------------------------
 IF (PrintStatus  >=   PrStatus_Normal) THEN
    WRITE(6,*) ' STPH_RP NEW PARAM VALUES'
#if defined(A05_4A)
    WRITE(6,*) 'entcoef .........', entcoef
#endif
    WRITE(6,*) 'rhcrit(4,7,10) ..', rhcrit(4),rhcrit(7),rhcrit(10)
