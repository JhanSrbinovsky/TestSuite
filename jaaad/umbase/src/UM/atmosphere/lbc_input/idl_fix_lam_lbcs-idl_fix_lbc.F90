...
!
! Author : Richard Forbes based on UPDATE_LAM_LBCs
...
! -------     -------    -------
!  5.3        10/10/01   This deck introduced            Terry Davies
!  5.5        03/02/03   Include qcf2,qrain,qgraup lbcs. R.M.Forbes
!  6.0        29/07/03   Include cloud fractions in lbcs. Damian Wilson
!  6.2        31/01/06   Add L_mcr*lbc variables in IF tests and pass
!                        in extended halo arrays. Richard Forbes
!
! Code Description:
