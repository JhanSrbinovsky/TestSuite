...
!
! Author :  R. Forbes based on COPY_ATMOS_LBCS
! Original Programmer:  R.Forbes
...
! 6.0       29/07/03    Add cloud fractions in lbcs     Damian Wilson
! 6.2       31/01/06    Add L_mcr_*_lbc variables in IF tests. R.Forbes
!
! Code Description:
