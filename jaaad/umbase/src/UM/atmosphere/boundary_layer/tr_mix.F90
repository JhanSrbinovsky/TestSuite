...
!LL   4.1  02/05/96  Surface emissions and dry deposition coefficients
!LL                  added as input arguments; surface deposition flux
!LL                  added as output argument.         M.Woodage
!LL   4.2   Oct. 96   T3E migration - *DEF CRAY removed
!LL                                     S J Swarbrick
!LL   4.5    Jul. 98  Kill the IBM specific lines (JCThil)
!LL   5.2   Nov. 00  RHOKH_RDZ passed in, multiplied by gamma locally
!LL                  and explicit entrainment K added.  A P Lock.
!LL   5.4   May 02   Changes required to convert to height
!LL                  coordinates on a sphere            A P Lock
!    5.5 17/04/03 Remove references to obsolete sections
!                 A03_3A,5A,5B,7A. T.White
!     6.2   Jan 06   Optimisations for the NEC          A P Lock
