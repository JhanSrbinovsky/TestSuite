...
!
          ...
          beta11_inv(l, i)=1.0_Real64/(1.0_Real64-theta11*r(l, i))
          gamma11(l, i)=theta11*t(l, i)
          h1(l, i)=g1(l, i+1)+theta11*s_down(l, i)

          beta22_inv(l, i)=1.0_Real64/(1.0_Real64-theta22*r_cloud(l, i))
...
!
      DO i=n_cloud_top-2, 1, -1
        DO l=1, n_profile
!
          beta11_inv(l, i)=1.0_Real64                                   &
     &      /(1.0_Real64-alpha11(l, i+1)*r(l, i))
