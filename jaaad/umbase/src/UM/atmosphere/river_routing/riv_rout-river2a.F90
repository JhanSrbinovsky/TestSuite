...
! *****************************COPYRIGHT*******************************
     ...
     &   DELTA_PHI,EARTH_RADIUS,FIRST,G2G_TIMESTEP,                     &
! ancillary variables
...
!   6.2   20/09/04  Declare ICOLS and JROWS before arrays they
!                   dimension;  remove duplicate declaration of
!                   FLOWOBS1A.                         P.Dando
!
!-----------------------------------------------------------------
      IMPLICIT NONE
