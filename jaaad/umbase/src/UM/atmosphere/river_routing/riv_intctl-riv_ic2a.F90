...
!
!  6.0  21.08.03 Adapted for use as the control routine for river
!                routing(grid-to-grid routing) for the RCM. V.A.Bell
!  6.2  10/04/05 Removed calls to ABORT.  J. Gill
!  6.2  12/05/05 Remove repeated declaration of variables.  P.Dando
! Code Description:
...
! DEPENDS ON: riv_rout
     ...
     &   GLOBAL_ROW_LENGTH, GLOBAL_ROWS,                                &
     &   DELTA_PHI,EARTH_RADIUS,FIRST,RIV_STEP,                         &
! ancillary variables
