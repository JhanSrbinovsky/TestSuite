...
!     IT IS NO LONGER POSSIBLE TO SOLVE FOR THEM ALL IN ONE GO.
      ...
      I_PROFILE=1
!
10       IF (N_LONG+N_COLUMN(I_PROFILE) <= NPD_PROFILE) THEN
...
!           MAY BE ADDED.
            IF (I_PROFILE <  N_PROFILE) THEN
               I_PROFILE=I_PROFILE+1
               GOTO 10
            ENDIF
!
         ELSE IF (N_COLUMN(I_PROFILE) >  NPD_PROFILE) THEN
