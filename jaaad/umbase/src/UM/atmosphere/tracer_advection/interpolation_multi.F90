...
! ----     -------   -------
! 6.1      24/06/04  Original deck (based on INTERP2A)
!                    Allows for super_tracer_arrays         A.Malcolm
...
! Arguments with Intent IN. ie: Input variables.
     ...
     &, row_length                                                      &
                     ! points on a row for dynamic arrays
     &, rows                                                            &
                     ! number of rows for dynamic arrays
     &, n_rows                                                          &
                     ! number of v-rows for dynamic arrays
     &, g_row_length                                                    &
