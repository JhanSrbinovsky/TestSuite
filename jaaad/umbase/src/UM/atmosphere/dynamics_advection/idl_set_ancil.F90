...
! 5.4      12/09/02    add 4th dimension to rad_hr    Andy Malcolm
! 5.4      18/10/02    change dimensions of cloud fields    Andy Malcolm
! 6.2      28/02/06    Option for tstar (sea) and tstar_tile(land) to
!                      be theta level 1 data. Yongming Tang
!
! Code Description:
