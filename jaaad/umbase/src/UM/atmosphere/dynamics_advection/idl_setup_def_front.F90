...
! ----     -------     -----
! 5.5      28/02/03    Code introduced              Richard Forbes
! 6.1      09/07/04    Correct pointers when L_trivial_trigs=F R.Forbes
! 6.2      31/01/06    Fix for f3_at_p reference in geop. R. Forbes
