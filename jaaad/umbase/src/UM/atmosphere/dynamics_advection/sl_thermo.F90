...
! ----     -------     -------
! ----     -------     -----
! 5.1      10/03/00    Code for UM style LAM LBCs          P.Burton
! 22/03/00 5.1         Changes for cyclic LAM configuration
!                                              Andy Malcolm
!LL   5.1   11/02/00  Use DOMTYP parameters                    P.Burton
!LL  5.2 26/09/00  interpolation in eta not z    Andy Malcolm
!LL   5.2   27/09/00  remove duplicate declaration statement   A.Malcolm
!LL  5.3  24/09/01  Portability changes.    Z. Gardner
! 5.3   25/07/01  save depart_r_theta, speed up tracer code  A.Malcolm
! 5.3      11/07/01     bug fix                          Andy Malcolm
! 5.3      05/10/01     correct array dimensions         Andy Malcolm
! 5.3      14/11/01     Dynamic allocation of memory used.  S. Cusack
! 5.4      27/07/02     Add advection of cloud fraction and exner for
!                       the PC2 scheme                   D. Wilson
! 5.5      03/02/03     Add advection of qcf2,qrain,qgraup.  R.M.Forbes
