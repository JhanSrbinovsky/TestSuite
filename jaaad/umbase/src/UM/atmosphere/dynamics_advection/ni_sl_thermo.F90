...
!                                                        M. Diamantakis
! 6.2     28/09/05  send rho into sl_thermo_mix              A. Malcolm
! 6.2      21/07/05    send moisture_array_size into sl_thermo
!                                                       A. Malcolm
!  6.2   24/09/05  control for monotone theta limiter   Terry Davies
!  6.2   25/12/05  Variable resolution changes            Yongming Tang
!  6.2   25/12/05  n_rims_to_do an argument for lbc updating
