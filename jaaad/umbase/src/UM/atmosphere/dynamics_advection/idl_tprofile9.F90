...
! ----     -------     -----
! 5.3      10/10/01    Code introduced              Terry Davies
! 5.4      29/08/02    Remove STOP and replace with a warning
!                      if tprofile=9 and orography.    Carol Roadnight
! 5.5      03/02/03    Enable t profile to be set correctly when
!                      orography is present.    Richard Forbes
! 6.2      31/01/06    Include option for interp method. Yongming Tang
!
! Code Description:
