...
!
! Current Code Owner: Andrew Malcolm
!
! History:
! Version   Date     Comment
! -------   ----     -------
!  5.5     03/02/03  Original code.              Andrew Malcolm
!  6.1     01/08/04  Interpolate forcing data to model levels. R.Forbes
! 6.1    04/10/04  Extra arrays for communication       A.Malcolm
...
!  6.2     31/01/06  Pass idl bubble variables through. R.Forbes
!  6.2     31/01/06  Add idealised perturbation variables. R.Forbes
!  6.2     05/01/06  Pass uvprofile vars into IDL_INIT_DATA. R.Forbes
!  6.2    03/01/06  Improve idealised runtime print output. R. Forbes.
!  6.2     31/01/06  Pass zprofile_orog through.   Yongming Tang
!  6.2     31/01/06  Pass orog_hgt_lbc variables through. Yongming Tang
!  6.2     29/02/06 Pass extra variables to IDL_SET_ANC2A. Yongming Tang
!  6.2     31/01/06  Moved idealised LBC code from ATMSTEP. R.Forbes
!  6.2  31/01/06  Include options to set idealised surface fluxes over
!                 the sea.                            Richard Forbes.
