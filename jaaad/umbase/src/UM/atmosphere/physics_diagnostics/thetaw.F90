...
! -------   ----     -------
! 5.2   17/01/01   Code based on vn4.5 THETAW1A methods but extensively
!                  revised for C_P C dynamics upgrade. R Rawlins
! 5.3   16/11/01   Generalize routine to work for any pressure surface.
!                  D.M. Goddard
! 5.3   26/09/01   Extra comment only. R Rawlins
!
! Code Description:
