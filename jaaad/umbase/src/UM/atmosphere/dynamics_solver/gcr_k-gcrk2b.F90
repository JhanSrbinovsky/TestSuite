...
! ----     -------     -------
!   6.2   20/12/05  Variable resolution changes      Yongming Tang
!   6.2   20/12/05  plus solver loop bounds changes     Terry Davies
!
! Code Description:
...
! DEPENDS ON: gcr_precon_dufort_frankel_setup
        Call GCR_precon_Dufort_Frankel_setup(                           &
     ...
     &             global_row_length, proc_row_group, Pi,               &
...
! DEPENDS ON: gcr_precon_adi_setup_trisolve
          Call GCR_precon_adi_setup_trisolve(                           &
     &                  HM_Cxx1, HM_Cxx2, HM_Cyy1, HM_Cyy2,             &
     &                  HM_Czz, HM_Cz, HM_C3, HM_C4,                    &
     &                  eta_theta_levels, eta_rho_levels,               &
     &                  row_length, rows, n_rows, model_levels,         &
...
! DEPENDS ON: gcr_precon_dufort_frankel_exec
        Call GCR_precon_Dufort_Frankel_exec(                            &
     &           r,                                                     &
     &           row_length, rows, n_rows, model_levels, model_domain,  &
...
! DEPENDS ON: gcr_precon_adi_exec_trisolve
          Call GCR_precon_adi_exec_trisolve(                            &
