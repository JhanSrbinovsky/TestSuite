...
!
!     Dummy arguments
      CHARACTER  (LEN=80), Intent(IN) :: sw_spectral_file
...
!           Use the direct radiative effects of dust in the SW
...
!           Include the direct radiative effect of seasalt in the SW
...
!           Include the direct radiative effect of fossil-fuel OC in SW
...
! DEPENDS ON: r2_allocate_spectrum
      call r2_allocate_spectrum(sw_spectrum)
!
