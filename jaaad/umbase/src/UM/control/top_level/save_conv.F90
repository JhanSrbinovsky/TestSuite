...
! Input data
     ...
     &     TR_LEVELS, TR_VARS, OFFX,OFFY,THETA_CONV, Q_CONV,            &
     &     qcl_conv, qcf_conv, cf_liquid_conv, cf_frozen_conv,          &
     &     bulk_cf_conv, theta_inc, q_inc,                              &
     &     qcl_inc, qcf_inc, cf_liquid_inc, cf_frozen_inc, bulk_cf_inc, &
     &     R_U, R_V, AEROSOL, DUST_DIV1,DUST_DIV2, DUST_DIV3,           &
     &     DUST_DIV4, DUST_DIV5, DUST_DIV6, SO2, SO4_AITKEN,            &
     &     so4_accu, so4_diss, dms, nh3, soot_new, soot_agd,            &
     &     soot_cld, ocff_new, ocff_agd, ocff_cld,                      &
     &     co2, free_tracers, ozone_tracer,                             &
     &     cclwp, conv_rain, conv_snow, nvars,                          &
! Output data
     &     resdump)
