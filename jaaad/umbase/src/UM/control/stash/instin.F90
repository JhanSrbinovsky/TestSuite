...
!
!
!     SUBROUTINE TO INSERT AN INTEGER VALUE INTO NBITS OF ICOMP
!     =========================================================
!
!     ICOMP  = FULLWORD ARRAY TO WHICH AN NBIT INTEGER IS TO BE ADDED
!     IWORD  = DIMESION OF ICOMP (ENABLES INTEGER TO CROSS WORDS)
!     ISTART = POSITION IN ICOMP WHERE AN NBIT INTEGER TO BE ADDED
!     NBIT   = NUMBER OF BITS INTO WHICH INTEGER IS TO BE STORED
!     INUM   = FULLWORD INTEGER TO BE ADDED TO ICOMP
