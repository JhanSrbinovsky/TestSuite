...
#else
!
!         Better vectorized version compressing the whole field at once
!
! DEPENDS ON: cmps_all
          CALL CMPS_ALL(FIELD,ICOMP,N,IX,IY,NUM,ISC,RMDI,               &
     &                  ICODE,CMESSAGE)
#endif
!
!         CHECK RETURN CODES
...
#else
!
!         Better vectorized version expanding the whole field at once
!
! DEPENDS ON: xpnd_all
