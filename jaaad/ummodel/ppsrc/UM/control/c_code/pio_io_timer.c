...
# 1 "/short/p66/jxs599/UM_ROUTDIR/jxs599/jaaad/ummodel/inc/c_fort2c.h" 1
# 28 "/short/p66/jxs599/UM_ROUTDIR/jxs599/jaaad/ummodel/inc/c_fort2c.h"
typedef double real;
# 44 "/short/p66/jxs599/UM_ROUTDIR/jxs599/jaaad/ummodel/inc/c_fort2c.h"
...
# 1 "/short/p66/jxs599/UM_ROUTDIR/jxs599/jaaad/ummodel/inc/c_io_timer.h" 1
# 26 "/short/p66/jxs599/UM_ROUTDIR/jxs599/jaaad/ummodel/inc/c_io_timer.h"
...
# 27 "/short/p66/jxs599/UM_ROUTDIR/jxs599/jaaad/ummodel/inc/c_io_timer.h" 2
...
# 28 "/short/p66/jxs599/UM_ROUTDIR/jxs599/jaaad/ummodel/inc/c_io_timer.h" 2
# 68 "pio_io_timer.c" 2


u_integer io_calls[4] = {0,0,0,0};
u_integer io_bytes[4] = {0,0,0,0};
u_integer io_secs[4] = {0,0,0,0};
u_integer io_usecs[4] = {0,0,0,0};

u_integer io_calls_last[4] = {0,0,0,0};
u_integer io_bytes_last[4] = {0,0,0,0};
u_integer io_secs_last[4] = {0,0,0,0};
u_integer io_usecs_last[4] = {0,0,0,0};

u_integer io_overhead = 0;
u_integer io_timer_active = 0;
...
(void)
{
   ...
   io_report( io_calls[0], io_bytes[0], io_secs[0],
              io_usecs[0], 0 );
   ...
   io_report( io_calls[1], io_bytes[1], io_secs[1],
              io_usecs[1], 1 );
   ...
   io_report( io_calls[2], io_bytes[2], io_secs[2],
              io_usecs[2], 2 );
   ...
   io_report( io_calls[3], io_bytes[3], io_secs[3],
              io_usecs[3], 3 );
...
(void)
{
   ...
   io_report( io_calls_last[0], io_bytes_last[0],
              io_secs_last[0], io_usecs_last[0], 0 );
   ...
   io_report( io_calls_last[1], io_bytes_last[1],
              io_secs_last[1], io_usecs_last[1],
              1 );
   ...
   io_report( io_calls_last[2], io_bytes_last[2],
              io_secs_last[2], io_usecs_last[2], 2 );
   ...
   io_report( io_calls_last[3], io_bytes_last[3],
              io_secs_last[3], io_usecs_last[3], 3 );
