...
!          Mark H. Mawson
!
! Original Programmer: S.Coulter
! Current code owner: A. J. Malcolm
!
! History:
...
!  6.2  06/10/05  Optimise code by cutting operation count    A. Malcolm
!
! Code Description:
...
! End of routine.
      return
      END SUBROUTINE Quintic_Lagrange
