...
! ----     -------     -------
! 5.4      02/04/02    original deck based on sl_moist   Andy Malcolm
! 6.1     27/05/04  catchup with changes made to sl_moist    A. Malcolm
! 6.2      25/05/06  Correct External statement. P.Selwood
! 6.2      21/07/05  super_array and update for extra species  A.Malcolm
