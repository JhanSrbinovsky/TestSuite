...
! Current code owner: Mark H. Mawson
!
! History:
! Version   Date     Comment
! -------   ----     -------
!  5.2    26/09/00   introduced to do interpolation in eta Andy Malcolm
!  5.3    11/07/01   add interpolation options 6 & 7       Andy Malcolm
!
!  5.3    25/10/01   Change from magic numbers     M.Diamantakis
!  6.4    26/01/07   Add code to fix bit-reproducibility bug caused by
!                    not using same logic as in eta_vert_weights.
!                                                             A Malcolm
! Code Description:
