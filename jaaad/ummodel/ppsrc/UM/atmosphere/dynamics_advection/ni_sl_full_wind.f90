...
! -------  -------   -------
! 5.5      17/12/02  Deck introduce               A. Malcolm
! 6.1      08/06/04  add L_interp_depart                A. Malcolm
! 6.2      04/10/05  Changes for cycling semi-Lagrangian scheme.
!                                                        M. Diamantakis
!  6.2  25/12/05  Variable resolution changes          Yongming Tang
!  6.2  25/12/05  rims_to_do now an argument      Terry Davies
!  6.4    11/12/06  1-point halo for q vars in iterative SL scheme 
!                                                        M. Diamantakis
!  6.4    11/12/06  Bug fix for mixing ration iterative SL scheme 
!                                                        M. Diamantakis
!
! Code Description:
