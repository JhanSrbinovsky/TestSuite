...
! DEPENDS ON: swap_bounds
      call swap_bounds(                                                 &
     &                 u_star_minus_u,row_length,rows,model_levels,     &
     &                 off_x,off_y,fld_type_p,.TRUE.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(u_star_minus_u,row_length,rows,          &
...
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(v_star_minus_v,row_length,n_rows,        &
     &                         model_levels,off_x,off_y)
...
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_Czz,row_length,rows,                  &
     &                         model_levels,                            &
     &                         off_x,off_y)
! DEPENDS ON: swap_bounds
      call swap_bounds(                                                 &
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_Cz,row_length,rows,                   &
     &                         model_levels,                            &
     &                         off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_RHS,row_length,rows,                  &
     &                         model_levels,off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_cxx1,row_length,rows,                 &
     &                         model_levels,off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_cxx2,row_length,rows,                 &
     &                         model_levels,off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_cxy1,row_length,rows,                 &
     &                         model_levels,off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_cxy2,row_length,rows,                 &
     &                         model_levels,off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_cxp,row_length,rows,                  &
     &                         first_constant_r_rho_level_m1,           &
     &                         off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_cxz,row_length,rows,                  &
     &                         first_constant_r_rho_level_m1,           &
     &                         off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_cyy1,row_length,rows,                 &
     &                         model_levels,off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_cyy2,row_length,rows,                 &
     &                         model_levels,off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_cyx1,row_length,rows,                 &
     &                         model_levels,off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_cyx2,row_length,rows,                 &
     &                         model_levels,off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_cyp,row_length,rows,                  &
     &                         first_constant_r_rho_level_m1,           &
     &                         off_x,off_y)
...
! DEPENDS ON: swap_bounds
     ...
     &                 off_x, off_y, fld_type_p, .false.)
! DEPENDS ON: fill_external_halos
      CALL FILL_EXTERNAL_HALOS(HM_cyz,row_length,rows,                  &
     &                         first_constant_r_rho_level_m1,           &
     &                         off_x,off_y)
