...
! Subroutine turb_diff_th
     ...
     &                        levels, diff_coeff_u, diff_coeff_v,       &
     &                        theta_star)
...
! ----------------------------------------------------------------------
        Do j = 1, rows
          Do i = 1-off_x, row_length
            temp(i,j) = (theta(i+1,j,k) * delta_z(i+1,j,k) -            &
     &                   theta(i  ,j,k) * delta_z(i  ,j,k) ) *          &
...
! ----------------------------------------------------------------------
        ...
        Do j = 0, rows
          Do i = 1, row_length
            temp(i,j) = (theta(i,j+1,k) * delta_z(i,j+1,k) -            &
     &                   theta(i,j,  k) * delta_z(i,j,  k) ) *          &
...
! DEPENDS ON: swap_bounds
      call Swap_Bounds(                                                 &
     &                 theta_star, row_length, rows, levels,            &
     &                 off_x, off_y, fld_type_p, .false.)

      return
      END SUBROUTINE turb_diff_th
