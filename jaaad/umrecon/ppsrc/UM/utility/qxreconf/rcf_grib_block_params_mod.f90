...
! -------  --------   -------------------------
!  5.4     05/03/02   Original code. Roddy Sharp (frtz)
!  5.5     13/02/03   Increased LenArrayMax to allow for importing of
!                     ECMWF data at 0.5 degree spacings. R.Sharp
!  5.5     20/02/03   Corrected "!\" commenting declaration of
!                     variable Len_Block_R.            P.Dando
!  6.2     20/06/05   Added Vertical Coordinates array to GRIB
!                     type definition. Paul Earnshaw (frpe)
!  6.2     16/02/06   Increased LenArrayMax to allow for importing of
!                     ECMWF data at 0.25 degree spacings.
!                                      Paul Earnshaw (frpe)
!
! Code Description:
!   Language: FORTRAN 90
...
Integer , Parameter    :: LenArrayMax =2100000 ! Max Array size used
                                               ! for work arrays and
                                               ! such in DECODE
